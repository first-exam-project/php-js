...
<body class="bg-black">
    ...
    ?>
    <div class="opacity-30 -z-50 fixed top-0 h-screen w-screen" style="background-image: url(../images/backgroundimage.jpg);">  </div>
        ...
        <div class="w-[85%] my-2">
            ...
            <div class="flex my-16 justify-around flex-wrap">
                ...
                <div class="flex w-4/5 ">
                    <input type="text" class="outline-none border border-orange-400 mx-3 rounded-lg bg-transparent">
